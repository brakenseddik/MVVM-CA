...
class _$_LoginObject implements _LoginObject {
  const _$_LoginObject(this.userName, this.password);
...
abstract class _LoginObject implements LoginObject {
  const factory _LoginObject(String userName, String password) = _$_LoginObject;
...
class _$RegisterObjectTearOff {
  ...
  _RegisterObject call(String email, String password, String name, String code,
...
class _$_RegisterObject implements _RegisterObject {
  const _$_RegisterObject(this.email, this.password, this.name, this.code,
      this.mobile, this.picture);
  ...
  @override
  String toString() {
    return 'RegisterObject(email: $email, password: $password, name: $name, code: $code, mobile: $mobile, picture: $picture)';
  }
...
abstract class _RegisterObject implements RegisterObject {
  const factory _RegisterObject(String email, String password, String name,
      String code, String mobile, String picture) = _$_RegisterObject;
